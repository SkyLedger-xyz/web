...
const Modal = ({
  ...
  const modalPanelClassNames = classNames(
    'z-50 relative text-left bg-white rounded-lg shadow-xl transition-all sm:my-28 sm:w-full sm:max-w-lg ',
    {
      'shadow-gray-900/10': true,
      'md:max-w-sm w-full': width === 's',
      'md:max-w-md w-full': width === 'm',
      'md:max-w-lg w-full': width === 'l',
      'md:max-w-xl w-full': width === 'xl',
      'md:max-w-2xl w-full': width === 'xxl',
    }
  );
  ...
  return (
    <Transition.Root show={isOpen} as={Fragment}>
      <Dialog as="div" className="relative" onClose={onClose} initialFocus={bodyRef}>
        <div className="fixed inset-0 bg-zinc-400 opacity-80 transition-opacity" />
