...
const Dropdown = forwardRef<any, any>(
  (
    ...
    const dropdownClassNames = classNames({
      'bg-white border border-gray-200 rounded-lg shadow-lg overflow-hidden': true,
      ...
      // width
      'md:max-w-xxxs w-screen': width === 'xs',
      'md:max-w-xxs w-screen': width === 's',
      'md:max-w-xs w-screen': width === 'm',
      'md:max-w-sm w-screen': width === 'l',
    });
