...
const Badge = React.forwardRef<any, any>(
  ({ theme = 'solid', size = 'm', color = 'gray', transform, lineClamp = false, children }: Badge, ref) => {
    const containerClassNames = classNames({
      // base
      'inline-flex items-center justify-between border min-w-0': true,

      // sizes
      'px-1 py-[0.18rem] text-xs space-x-2 rounded-lg': size === 'xs',
      'px-2 py-1 text-sm space-x-2 rounded-lg': size === 's',
      'px-3 py-1 text-base leading-tight space-x-2 rounded-lg': size === 'm',
      'px-3 py-1 text-lg leading-tight space-x-2 rounded-lg ': size === 'l',

      // theme solid
      'bg-gray-800 text-gray-200 border-gray-800': color === 'white' && theme === 'solid',
      'bg-gray-200 text-gray-600 border-gray-100': color === 'gray' && theme === 'solid',
      'text-green-800 bg-green-100 border-green-100': color === 'green' && theme === 'solid',
      ...
      'bg-yellow-200 text-yellow-800 border-yellow-50': color === 'yellow' && theme === 'solid',
      ...
      'border-yellow-700 text-yellow-700': color === 'yellow' && theme === 'ghost',
      ...
      'text-yellow-700': color === 'yellow' && theme === 'bare',
